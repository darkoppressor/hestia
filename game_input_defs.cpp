...
void Game_Manager::handle_input_states_gui(){
    ...
    if(in_progress && Game::started){
        ...
        if(Game::edge_scroll_input_state("left") && Game::edge_scroll_input_state("up") && Game::edge_scroll_input_state("right")){
            Game::edge_scroll_state="left_up";
        }
        if(Game::edge_scroll_input_state("left") && Game::edge_scroll_input_state("down") && Game::edge_scroll_input_state("right")){
            Game::edge_scroll_state="left_down";
        }
        if(Game::edge_scroll_input_state("left") && Game::edge_scroll_input_state("up") && Game::edge_scroll_input_state("down")){
            Game::edge_scroll_state="left_up";
        }
        if(Game::edge_scroll_input_state("up") && Game::edge_scroll_input_state("right") && Game::edge_scroll_input_state("down")){
            Game::edge_scroll_state="right_up";
        }
        if(Game::edge_scroll_input_state("left") && Game::edge_scroll_input_state("up") && Game::edge_scroll_input_state("right") && Game::edge_scroll_input_state("down")){
            Game::edge_scroll_state="left_up";
        }
        if(!Game::edge_scroll_input_state("left") && !Game::edge_scroll_input_state("up") && !Game::edge_scroll_input_state("right") && !Game::edge_scroll_input_state("down")){
                ...
                if(Game::is_mouse_over_minimap()){
                    ...
                    if(!event_consumed && Engine_Input::event.wheel.y>0){
                        if(Game_Options::zoom_to_cursor){
                            ...
                            double magnitude=50.0/(Game_Manager::camera_zoom/(Math::get_distance_between_points(Coords<double>(box_camera.x,box_camera.y),Coords<double>(box_mouse.x,box_mouse.y))/screen_distance));
